...
# BiMap
# =====================================================
class TestBiMapPythonFunctionEinsum(TestCase):
    """Test of the BiMap python function with einsum."""
    ...
    def test_basic2D_decrease(self):
        ...
        Y = functions.biMap(X, W, self.mm_mode)
...
class TestBiMapGradientEinsum(TestCase):
    """Test of the BiMap gradient with einsum."""
    def setUp(self):
        self.n_in = 17
        self.n_out_decrease = 7
        self.n_out_increase = 50
...
class TestBiMapPythonFunctionBMM(TestCase):
    """Test of the BiMap python function with bmm."""
...
class TestBiMapGradientBMM(TestCase):
    """Test of the BiMap gradient with bmm."""
    def setUp(self):
        self.n_in = 17
        self.n_out_decrease = 7
        self.n_out_increase = 50
