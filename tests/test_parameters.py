...
class TestStiefelParameter(TestCase):
    ...
    def test_increase_dim(self):
        """Test initialization of StiefelParameter with increasing dimensions"""
        n_in = 30
        n_out = 70
        W = Stiefel(n_out, n_in).random_uniform(1)
        W = parameters.StiefelParameter(W, verify_stiefel=False)
        self.assertEqual(W.shape, (n_out, n_in))

    def test_decrease_dim_batches(self):
        """Test initialization of StiefelParameter with decreasing dimensions and batches"""
        n_in = 70
        n_out = 30
        n_batches = 5
    ...
    def test_increase_dim_batches(self):
        """Test initialization of StiefelParameter with increasing dimensions and batches"""
        n_in = 30
        n_out = 70
        n_batches = 5
